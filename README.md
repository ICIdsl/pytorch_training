...
For details on:<br/>
**MuPPET: Multi-precision policy enforced training**: https://github.com/ICIdsl/muppet.git <br/>
**Now that I can see, I can improve: Enabling data-drive finetuning on CNNs on the edge**: https://github.com/adityarajagopal/pruning.git <br/>
